    ...
    <div class="searchWrapper" v-loading="searchLoading">
      ...
      <div class="searchListWrapper" style="margin-top:0;padding-top:0;">
        <el-table class="mainTable" :data="mainList" size="mini" style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="dynasty" label="朝代" align="center" min-width="60"></el-table-column>
          <el-table-column prop="author" label="作者" align="center" min-width="80"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getMainList() {
        this.loading = true;
        let newParams = {};
        this.$post("poemList", this.params, data => {
